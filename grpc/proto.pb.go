...
const file_grpc_proto_proto_rawDesc = "" +
	...
	"\tSendReply\x12\x06.Reply\x1a\x06.Empty\"\x00B\x0fZ\rARGAWALA/grpcb\x06proto3"
...
var file_grpc_proto_proto_depIdxs = []int32{
	0, // 0: ArgaWala.SendRequest:input_type -> Request
	1, // 1: ArgaWala.SendReply:input_type -> Reply
	2, // 2: ArgaWala.SendRequest:output_type -> Empty
	2, // 3: ArgaWala.SendReply:output_type -> Empty
